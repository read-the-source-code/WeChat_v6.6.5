...
# instance fields
.field public KA:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.field public Ky:Landroid/support/v7/view/menu/f$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KB:Z
    ...
    iput v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KD:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KF:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KE:I
...
.method static synthetic a(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/ActionMenuItemView$b;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KA:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method static synthetic b(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/f$b;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Ky:Landroid/support/v7/view/menu/f$b;
...
.method static synthetic c(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/h;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->eb:Landroid/support/v7/view/menu/h;
...
.method private dn()V
    ...
    .line 173
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->uU:Ljava/lang/CharSequence;
    ...
    .line 174
    :goto_0
    iget-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jY:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_0

    iget-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->eb:Landroid/support/v7/view/menu/h;

    iget v3, v3, Landroid/support/v7/view/menu/h;->LF:I
    ...
    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KB:Z

    if-nez v3, :cond_0

    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KC:Z
...
.method public final a(Landroid/support/v7/view/menu/h;)V
    ...
    .line 112
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->eb:Landroid/support/v7/view/menu/h;
    ...
    iput-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jY:Landroid/graphics/drawable/Drawable;
    ...
    iget v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KF:I
    ...
    iget v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KF:I
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KF:I
    ...
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->dn()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->uU:Ljava/lang/CharSequence;
    ...
    .line 121
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kz:Landroid/support/v7/widget/ListPopupWindow$b;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Kz:Landroid/support/v7/widget/ListPopupWindow$b;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->eb:Landroid/support/v7/view/menu/h;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KB:Z
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 250
    :cond_1
    iget-object v8, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->eb:Landroid/support/v7/view/menu/h;
...
.method protected onMeasure(II)V
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KE:I
    ...
    iget v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KD:I
    ...
    iget v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KD:I
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jY:Landroid/graphics/drawable/Drawable;
    ...
    .line 289
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jY:Landroid/graphics/drawable/Drawable;
    ...
    .line 276
    :cond_3
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KD:I
...
.method public setPadding(IIII)V
    ...
    .prologue
    .line 103
    iput p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->KE:I
