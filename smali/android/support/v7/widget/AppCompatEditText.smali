...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatEditText;->Pc:Landroid/support/v7/widget/h;

    .line 63
    new-instance v0, Landroid/support/v7/widget/f;

    iget-object v1, p0, Landroid/support/v7/widget/AppCompatEditText;->Pc:Landroid/support/v7/widget/h;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/f;-><init>(Landroid/view/View;Landroid/support/v7/widget/h;)V

    iput-object v0, p0, Landroid/support/v7/widget/AppCompatEditText;->Pd:Landroid/support/v7/widget/f;

    .line 64
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatEditText;->Pd:Landroid/support/v7/widget/f;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatEditText;->Pe:Landroid/support/v7/widget/l;

    .line 67
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatEditText;->Pe:Landroid/support/v7/widget/l;
