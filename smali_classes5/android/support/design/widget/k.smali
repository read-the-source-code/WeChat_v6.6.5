...
.method static synthetic a(Landroid/support/design/widget/k;Z)Z
    ...
    .prologue
    .line 25
    iput-boolean p1, p0, Landroid/support/design/widget/k;->im:Z
...
.method final a(Landroid/support/design/widget/l$a;Z)V
    ...
    .line 46
    iget-boolean v0, p0, Landroid/support/design/widget/k;->im:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/k;->iE:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method final ad()V
    ...
    iget-object v1, p0, Landroid/support/design/widget/k;->in:Landroid/support/design/widget/o;
    ...
    iget v3, v1, Landroid/support/design/widget/o;->fN:F

    cmpl-float v3, v3, v2

    if-eqz v3, :cond_0

    iput v2, v1, Landroid/support/design/widget/o;->fN:F

    invoke-virtual {v1}, Landroid/support/design/widget/o;->invalidateSelf()V

    :cond_0
    iget-object v1, p0, Landroid/support/design/widget/k;->iz:Landroid/support/design/widget/d;
    ...
    iget v2, v1, Landroid/support/design/widget/d;->fN:F

    cmpl-float v2, v0, v2

    if-eqz v2, :cond_1

    iput v0, v1, Landroid/support/design/widget/d;->fN:F
