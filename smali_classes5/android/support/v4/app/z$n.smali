...
.method public final b(Landroid/support/v4/app/z$d;)Landroid/app/Notification;
    ...
    iget-object v1, p1, Landroid/support/v4/app/z$d;->sx:Landroid/app/Notification;

    iget-object v2, p1, Landroid/support/v4/app/z$d;->rY:Ljava/lang/CharSequence;

    iget-object v3, p1, Landroid/support/v4/app/z$d;->rZ:Ljava/lang/CharSequence;

    iget-object v4, p1, Landroid/support/v4/app/z$d;->sf:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/z$d;->sd:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/z$d;->sg:I

    iget-object v7, p1, Landroid/support/v4/app/z$d;->sa:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/z$d;->sc:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/z$d;->se:Landroid/graphics/Bitmap;
