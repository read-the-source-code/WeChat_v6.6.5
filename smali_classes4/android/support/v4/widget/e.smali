...
.field protected BC:Landroid/support/v4/widget/e$a;

.field protected BD:Landroid/database/DataSetObserver;

.field protected BE:Landroid/support/v4/widget/f;

.field protected BF:Landroid/widget/FilterQueryProvider;
...
.method public changeCursor(Landroid/database/Cursor;)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/e;->BC:Landroid/support/v4/widget/e$a;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v4/widget/e;->BD:Landroid/database/DataSetObserver;
    ...
    :cond_3
    iput-object p1, p0, Landroid/support/v4/widget/e;->BA:Landroid/database/Cursor;
    ...
    iput v1, p0, Landroid/support/v4/widget/e;->BB:I

    const/4 v1, 0x1

    iput-boolean v1, p0, Landroid/support/v4/widget/e;->By:Z
...
.method public getCount()I
    ...
    .prologue
    .line 201
    iget-boolean v0, p0, Landroid/support/v4/widget/e;->By:Z
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/e;->BA:Landroid/database/Cursor;
...
.method public getFilter()Landroid/widget/Filter;
    ...
    .prologue
    .line 404
    iget-object v0, p0, Landroid/support/v4/widget/e;->BE:Landroid/support/v4/widget/f;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/e;->BE:Landroid/support/v4/widget/f;
...
.method public getItemId(I)J
    ...
    .line 224
    iget-boolean v2, p0, Landroid/support/v4/widget/e;->By:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/support/v4/widget/e;->BA:Landroid/database/Cursor;
    ...
    iget v1, p0, Landroid/support/v4/widget/e;->BB:I
...
.method protected final onContentChanged()V
    ...
    .prologue
    .line 447
    iget-boolean v0, p0, Landroid/support/v4/widget/e;->Bz:Z
    ...
    iput-boolean v0, p0, Landroid/support/v4/widget/e;->By:Z
...
.method public runQueryOnBackgroundThread(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    .prologue
    .line 396
    iget-object v0, p0, Landroid/support/v4/widget/e;->BF:Landroid/widget/FilterQueryProvider;
