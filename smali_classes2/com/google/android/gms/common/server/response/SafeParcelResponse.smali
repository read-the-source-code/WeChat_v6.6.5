...
# instance fields
.field final aPe:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

.field private final aPl:Landroid/os/Parcel;
...
.method constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPl:Landroid/os/Parcel;

    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPm:I

    iput-object p3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPe:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPe:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    if-nez v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->rd:Ljava/lang/String;

    :goto_0
    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPn:I
    ...
    iget-object v0, v0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->aPi:Ljava/lang/String;
...
.method private static a(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/c/x;->aY(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/gms/c/s;->j([B)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/gms/c/s;->k([B)Ljava/lang/String;
...
.method private a(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->pa()Z
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->oZ()I
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->pf()Ljava/util/Map;
    ...
    invoke-static {v0}, Lcom/google/android/gms/c/x;->aY(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/gms/c/s;->j([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/gms/c/s;->k([B)Ljava/lang/String;
...
.method private a(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->pc()I
    ...
    iget-object v1, v0, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->aPf:Lcom/google/android/gms/common/server/response/FastJsonResponse$a;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->oZ()I
...
.method private b(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->oY()Z
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->oX()I
...
.method public final oU()Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->rd:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->aP(Ljava/lang/String;)Ljava/util/Map;
...
.method protected final oV()Ljava/lang/Object;
    .locals 2
...
.method public final pi()Landroid/os/Parcel;
    ...
    iget v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPn:I

    packed-switch v0, :pswitch_data_0

    :goto_0
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPl:Landroid/os/Parcel;
    ...
    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPo:I

    :pswitch_1
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPl:Landroid/os/Parcel;

    iget v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPo:I

    invoke-static {v0, v1}, Lcom/google/android/gms/common/internal/safeparcel/b;->u(Landroid/os/Parcel;I)V

    const/4 v0, 0x2

    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPn:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->pi()Landroid/os/Parcel;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->aPe:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->rd:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->aP(Ljava/lang/String;)Ljava/util/Map;
