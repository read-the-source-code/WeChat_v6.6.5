...
# instance fields
.field final aPg:Ljava/util/HashMap;
...
.field private final aPh:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(ILjava/util/ArrayList;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->aPh:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->aPg:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->aPi:Ljava/lang/String;

    invoke-direct {p0}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->pg()V
...
.method private static c(Ljava/util/ArrayList;)Ljava/util/HashMap;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->ph()Ljava/util/HashMap;
...
.method private pg()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->aPg:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->aPg:Ljava/util/HashMap;
    ...
    iput-object p0, v1, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->aPe:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
...
# virtual methods
.method public final aP(Ljava/lang/String;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
